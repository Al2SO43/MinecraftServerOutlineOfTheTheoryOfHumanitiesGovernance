...
而对于特权化管理的服务器,也就是我们常说的神权服,更是要被抵制,我也遇到过无数的神权服务器,尽管这些服务器最终也都要消亡,但是却也有一定的受众,可能是这些玩家能做到和服主有一定的勾结吗?或者说是不知道服务器是神权的,然后在服务器付出了一定时间成本之后,哪怕被欺压了也不敢轻易还击,否则自己的心血就付之东流了.
### 明辨服务器的运行本质
